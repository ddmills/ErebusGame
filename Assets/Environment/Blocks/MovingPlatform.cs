...
//It also moves any rigidbodies on top along with it;
public class MovingPlatform : MonoBehaviour {
	...
	//This coroutine ensures that platform movement always occurs after Fixed Update has been called on all other objects;
	...
	void MovePlatform () {
		...
		//Move all rigidbodies on top of the platform the same distance;
