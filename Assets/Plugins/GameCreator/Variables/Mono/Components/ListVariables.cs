namespace GameCreator.Variables
{
    ...
    public class ListVariables : LocalVariables
    {
        ...
        public Variable Get(int index)
        {
            ...
            this.iterator = index;
            return this.variables[this.iterator];
        }
        ...
        public void Push(object value, int index)
        {
            ...
            this.iterator = Math.Min(index, this.variables.Count);
            this.variables.Insert(this.iterator, variable);

            VariablesManager.events.OnListAdd(gameObject, this.iterator, value);
        }
        ...
        public void Remove(int index)
        {
            ...
            if (this.iterator > index) this.iterator -= 1;
